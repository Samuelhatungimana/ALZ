<%@ Page Title="" Language="C#" MasterPageFile="~/ALZ/ALZ.Master" AutoEventWireup="true" CodeBehind="Confirm.aspx.cs" Inherits="ALZ.ALZ.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p align="center">
     ...
     <div class="row">
         ...
         <div class="col-6">
             <p1>
                 I am a    <asp:RadioButton ID="TeamCaptain" GroupName="contribution"  Checked="true" runat="server" /> team captain  <asp:RadioButton ID="TeamMember" GroupName="contribution"   runat="server" />  team member  <asp:RadioButton ID="Individual" GroupName="contribution"    runat="server" />   individual <br />
                 My goal is to raise $  <asp:Label ID="lblAmount" runat="server" Text=""></asp:Label>  to help end Alzheimer’s disease. <br />
         ...
         <div class="col-12">
             ...
             <table cellpadding="5"  cellspacing="5">
                 ...
                 <tr>
                     ...
                     <td>
                         <p>
                             <asp:CheckBox ID="txtConfirm" Checked="True" runat="server" /> &nbsp; 
 ...
 <br />
         ...
         <div class="Assumption">
                     ...
                     <div class="col-10">
                         ...
                         <p>
                             How did you hear about this year’s Walk? &nbsp;
                              ...
                              <asp:Label ID="lbltOthers" runat="server" Text=""></asp:Label><br /> <br />
          ...
          <br />
           ...
           <p>
               <asp:Button ID="btnsubmit" Text="SUBMIT" CssClass="btn btn-dark" OnClick="btnsubmit_Click" runat="server" />
               <asp:Button ID="btncancel" Text="CANCEL"  CssClass="btn btn-red" OnClick="btncancel_Click" runat="server" />
           </p>
